                    ...
                    >
                        <Box className={"review_box"}>
                            ...
                            <p className={"review_desc"}>
                                I really like the food of this restaurant. I
            ...
            <Container className="member_reviews">
                ...
                >
                    <Box
                        ...
                        sx={{
                            backgroundImage:
                                `url(/restaurant/burak.jpeg)`.replaceAll(
                                    "\\",
                                    "/"
                                ),
                        }}
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="about_right_desc">
                                        ...
                                        <p>
                                            Our chefs are qualified in
                                            world-renowned universities have
                                            increased
                                        </p>
                                    </div>
                                </Box>
